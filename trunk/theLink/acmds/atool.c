...
)
{
  ...
  if (argc < 2) {
    ...
    MqFactoryAdd (MQ_ERROR_PANIC, "cut",   CutFactory,   NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    MqFactoryAdd (MQ_ERROR_PANIC, "sort",  SortFactory,  NULL, NULL, NULL, NULL, NULL, NULL, NULL);
