...
)
{
  ...
  if (argc < 2) {
    ...
    // add Factory 
    MqFactoryAdd("split", SplitFactory, NULL, NULL, NULL, NULL, NULL);
    MqFactoryAdd("cut",   CutFactory,   NULL, NULL, NULL, NULL, NULL);
    MqFactoryAdd("sort",  SortFactory,  NULL, NULL, NULL, NULL, NULL);
