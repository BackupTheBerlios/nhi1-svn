...
/*
PHP_METHOD(MsgqueForPhp_MqSException, __construct)
{
}
*/
...
ZEND_BEGIN_ARG_INFO_EX(MsgqueForPhp_no_arg, 0, 0, 0)
ZEND_END_ARG_INFO()

static const zend_function_entry MqSException_functions[] = {
  PHP_ME(MqSExceptionC, getNum, MsgqueForPhp_no_arg, ZEND_ACC_PUBLIC)
  PHP_ME(MqSExceptionC, getTxt, MsgqueForPhp_no_arg, ZEND_ACC_PUBLIC)
  {NULL, NULL, NULL}
};
